...
const sampleScenes=[
 ...
 {src:'assets/sample-cascada-lava.jpg',title:'Cascada de Lava: El santuario de magma.',text:'Cámaras ancestrales talladas en piedra profunda. Una columna vertical de lava ilumina la cúpula resguardando secretos de expediciones pasadas.',alt:'Cámara con cascada de lava de Grim Kingdoms'}
];
